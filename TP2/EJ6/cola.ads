generic
   ...
   package Cola is
      type Tcola(Max:Positive) is limited private;-- diferencia entre private y limited private: private se define en usar y limited private se define en el paquete mas abajo
