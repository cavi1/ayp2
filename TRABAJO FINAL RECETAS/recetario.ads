...
package Recetario is
   ...
   procedure Buscar_Receta (Recetario: in out Trecetario; nombre_receta: in out cade_nombre_receta; long_nombre: in positive; encontrado: out boolean ) ;
   procedure Crear_Recetario( Recetario: in out Trecetario);-- inicializar la lista osea crear y limpiar
   procedure Generar_Listado (Recetario: in out Trecetario);
