...
begin
   --loop
   --begin
   if not vacia(receta.lista_ingredientes) then
   ...
   ptr:=receta.lista_ingredientes;  
      ...
      Put_Line("la lista de ingredientes está vacía");
...
begin
   return receta.Nombre_Receta;
end Info_Nombre_Receta;

function Info_Long_Nombre_Receta(Receta: Treceta) return Positive is
begin
   return Receta.Long_Nombre_Receta;
end Info_Long_Nombre_Receta;
